...
public class StopComponentInstance implements CliCommand {
    ...
    public void execute(String[] params) {
        try {
            ...
            componentAssembler.stopComponentInstance(Long.parseLong(params[0]));
            System.out.println("Stopping instance with ID " + params[0]);
        } catch (ComponentInstanceNotFoundInRE e) {
            System.err.println("Can't find an instance with the ID " + params[0]);
