...
public interface ComponentAssembler {
     ...
     * @return REComponent
     */
    REComponent loadComponentIntoRE(String pathToJarFile) throws ComponentAlreadyLoadedInRE, NoAnnotatedMethodPresentOnComponentInstance, IOException;
     ...
     */
    REComponent unloadComponentFromRE(String name, String version) throws Exception, ComponentNotLoadedInRE;
     ...
     */
    long startComponentInstance(String name, String version) throws ComponentNotLoadedInRE, InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException, NoAnnotatedMethodPresentOnComponentInstance, IOException;
